...
<head>
    ...
    <title>TeamSync - Potencia la colaboración en competencias de innovación</title>
...
<body>
    ...
    <section class="cta-banner">
        ...
        <div class="cta-buttons">
            ...
            <a href="#" class="btn-secondary">Explorar Eventos</a>
        </div>
    </section>
        ...
        <div class="footer-container">
            <div class="footer-content">
                <div class="footer-section footer-about">
                    ...
                    <p>La plataforma definitiva para la gestión de equipos en eventos de innovación y tecnología. Conecta, colabora y triunfa.</p>
                ...
                <div class="footer-section footer-contact">
                    ...
                    <ul class="contact-info">
                        ...
                        <li>
                            ...
                            <span>contacto@teamsync.com</span>
                        </li>
                        <li>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="footer-bottom">
                <p>&copy; {{ date('Y') }} TeamSync. Todos los derechos reservados.</p>
