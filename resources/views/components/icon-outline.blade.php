...
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" {{ $attributes->merge(['class' => 'inline-block align-middle ' . $class, 'style' => 'width: 20px; height: 20px;']) }}>
    {!! $content !!}
</svg>
