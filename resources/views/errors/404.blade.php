...
@section('title', 'Página No Encontrada - TeamSync')

@section('content')
<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh; text-align: center;">
    <div style="font-size: 120px; font-weight: 800; color: #3b82f6; line-height: 1;">404</div>
    <h1 style="font-size: 2rem; color: #1f2937; margin-top: 20px; margin-bottom: 10px;">Página No Encontrada</h1>
